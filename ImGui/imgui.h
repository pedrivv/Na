...
namespace ImGui
{
    ...
    IMGUI_API bool          TabHeader(const char* tabname, int* currentTab, std::vector<const char*> Tabs);   // button
    IMGUI_API bool          TabHeaderButton(const char* ButtonName, bool enabled, int direction);
